...
// !!! 2 кода кароче в першому я поняв шо не треба її дублювати и шось ще інше поняв (карточки все одно не міняются при переході на інші сторінкі), а в другому помилка Reference error: renderEvents is not defined !!!